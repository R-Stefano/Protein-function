...
flags.DEFINE_integer('num_examples', 433914, 'Number of examples in the dataset')
flags.DEFINE_float('ratio_test_examples', 0.25, 'Ratio of examples for testing')
...
flags.DEFINE_integer('target_size', 3, 'Length of the label hot vec')
